...
import { Search, Menu, User, Heart, ShoppingCart, Bell, Check, AlertCircle, X } from 'lucide-react';
...
export function Header() {
  ...
  // Mock notifications count - replace with actual notifications when implemented
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-80 p-2">
                  ...
                  <div className="space-y-2 max-h-60 overflow-y-auto p-1">
                    <div className="flex items-start p-2 rounded-md bg-blue-50 cursor-pointer">
                      <div className="bg-green-100 p-1.5 rounded-full">
                        <Check className="h-4 w-4 text-green-600" />
                      </div>
                      <div className="ml-3 flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900">Order Shipped</p>
                        <p className="text-xs text-gray-600">Your order #12345 is on its way</p>
                    ...
                    <div className="flex items-start p-2 rounded-md hover:bg-gray-50 cursor-pointer">
                      ...
                      <div className="ml-3 flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900">New Feature</p>
                        <p className="text-xs text-gray-600">Check out our new bulk order tool</p>
